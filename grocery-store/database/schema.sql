    -- Create database
    CREATE DATABASE IF NOT EXISTS groc_ST;
    USE groc_ST;
...
(1, 'Fruits & Vegetables', 'Fresh fruits and vegetables'),
(2, 'Dairy & Eggs', 'Dairy products and fresh eggs'),
(3, 'Meat & Seafood', 'Fresh and frozen meat and seafood'),
(4, 'Pantry', 'Canned goods, pasta, rice, and other dry goods'),
(5, 'Beverages', 'Drinks, coffee, tea, and juices'),
(6, 'Bakery', 'Fresh bread and pastries'),
(7, 'Snacks', 'Snacks and chips'),
(8, 'Canned Goods', 'Canned foods and preserves'),
(9, 'Condiments', 'Sauces and condiments'),
(10, 'Household', 'Household items and cleaning supplies'),
(11, 'Personal Care', 'Personal care and hygiene products')
